...
export default async function Home({
  ...
  uiConfig = isUiConfig(uiConfigDetails.value)
    ? uiConfigDetails.value
    : DEFAULT_UI_CONFIG;
      ...
      <div className="mx-auto max-w-3xl">
        <header className="mb-10">
          ...
          <p className="mt-2 text-zinc-600 dark:text-zinc-400">
            Next.js Server Component example — all flag evaluations happen
            server-side.
          </p>
          <form
            action={evaluateWithEntity}
